  ...
  return (
    <div className="space-y-6">
      ...
      {SECTIONS.filter(s => data.landingSections && data.landingSections[s.id]).length > 0 && (
        <div className="space-y-4">
          <div className="mb-4">
            <h3 className="block text-xs font-semibold text-slate-700 uppercase tracking-wide mb-1.5">Dynamic Section Content</h3>
          ...
          <div className="space-y-4">
            {SECTIONS.filter(s => data.landingSections && data.landingSections[s.id]).map(section => (
              <div key={section.id}>
                <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wide mb-1.5">{section.name} Details</label>
                <textarea 
